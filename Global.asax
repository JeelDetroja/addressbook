...
<script runat="server">
    ...
    public static void RegisterRoutes(System.Web.Routing.RouteCollection routes)
    {
        ...
        routes.MapPageRoute("AdminPanelUserLogin", "AdminPanel/User/Login", "~/AdminPanel/User/LogInPage.aspx");
        routes.MapPageRoute("AdminPanelUserRegistration", "AdminPanel/User/Registration", "~/AdminPanel/User/UserRegistration.aspx");

        routes.MapPageRoute("AdminPanelDefault", "AdminPanel/Default/Home", "~/AdminPanel/Default/Default.aspx");
